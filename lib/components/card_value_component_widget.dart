  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Adjusted base width for scaling to handle smaller cards better
        final scaleFactor = (cardWidth / 65.0).clamp(0.4, 2.0);
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                ...
                offset: Offset(0.0, 1.5 * scaleFactor),
              )
            ],
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.only(
                        topLeft: Radius.circular(5 * scaleFactor),
                        topRight: Radius.circular(5 * scaleFactor),
                      ),
                    ),
                    child: Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            FaIcon(FontAwesomeIcons.handFist, color: Colors.redAccent, size: 8 * scaleFactor),
                            SizedBox(width: 1 * scaleFactor),
                            Text(
                          ...
                          builder: (context) {
                            ...
                            if (imageUrl != 'N/A' && imageUrl.isNotEmpty) {
                              ...
                              return Image.network(
                                ...
                                height: double.infinity,
                                fit: BoxFit.cover,
                                errorBuilder: (context, error, stackTrace) => _buildTypeIcon(cardName, 18 * scaleFactor),
                              );
                            }
                            return _buildTypeIcon(cardName, 18 * scaleFactor);
                          },
                        ),
                      ),
                    ),
                  ...
                  Container(
                    width: double.infinity,
                    padding: EdgeInsets.symmetric(vertical: 1.0 * scaleFactor),
                    decoration: BoxDecoration(
                      color: Colors.black.withValues(alpha: 0.05),
                      borderRadius: BorderRadius.only(
                        bottomLeft: Radius.circular(5 * scaleFactor),
                        bottomRight: Radius.circular(5 * scaleFactor),
                      ),
                    ),
                    child: Text(
                      ...
                      style: FlutterFlowTheme.of(context).bodySmall.override(
                            ...
                            fontSize: (8.0 * scaleFactor).clamp(6.0, 12.0),
                          ),
                    ),
                  ),
                ],
