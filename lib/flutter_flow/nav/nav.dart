...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? LandingPageWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: BattleZonePlayCompWidget.routeName,
          path: BattleZonePlayCompWidget.routePath,
          builder: (context, params) => BattleZonePlayCompWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: QuePageWidget.routeName,
          path: QuePageWidget.routePath,
          builder: (context, params) => QuePageWidget(),
        ),
        FFRoute(
